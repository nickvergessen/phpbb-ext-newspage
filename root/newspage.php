...
*
* @package - NV newspage
* @version $Id: newspage.php 169 2009-07-15 17:42:21Z nickvergessen $
...
// Get attachments
if (sizeof($post_ids) && ($config['news_attach_show'] != 0))
{
...
while ($row = $db->sql_fetchrow($result))
{
	...
	$template->assign_block_vars('postrow', array(
		...
		'S_HAS_ATTACHMENTS'		=> (!empty($attachments[$row['post_id']]) && ($config['news_attach_show'] != 0)) ? true : false,
